...
class CourseraCoursesComponent(LCToolComponent):
    """Simple Coursera Paid Courses component for searching free courses"""
    display_name: str = "Coursera Courses Search"
    description: str = "Search Udemy paid courses available for free"
    name = "CourseraCoursesSearch"
    icon = "GraduationCap"
    inputs = [
        SecretStrInput(
            name="rapidapi_key",
    ...
    def search_courses(self, query: str, page: int = 1, page_size: int = 10) -> Dict[str, Any]:
        ...
        try:
            url = "https://coursera-paid-courses-for-free-api.p.rapidapi.com/rapidapi/courses/search"
            ...
            headers = {
                'x-rapidapi-host': 'coursera-paid-courses-for-free-api.p.rapidapi.com',
    ...
    def build_tools(self) -> Sequence[Tool]:
        """Build and return the Coursera course search tools"""
        tools = [
            Tool(
                name="search_courses",
                description="""
                Search for free Coursera courses.
                Parameters:
